...
Running Python scripts ablation.py, ablation_bae.py, ablation_cfgen.py, and sensitivity.py reproduces the results reported for our sensitivity analyses in the Supplements. 
